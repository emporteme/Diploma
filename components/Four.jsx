        ...
        <>
            ...
            <div className={styles.four}>
                <div className={styles.block}>
                    ...
                    <div style={{ fontSize: '1.2rem', fontWeight: '700' }}>Verified Information</div>
                ...
                <div className={styles.block}>
                    <FaBookOpen size={50} />
                    <div style={{ fontSize: '1.2rem', fontWeight: '700' }}>Wide features</div>
